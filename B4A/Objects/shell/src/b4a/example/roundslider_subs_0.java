...
try {
		Debug.PushSubsStack("getValue (roundslider) ","roundslider",43,__ref.getField(false, "ba"),__ref,182);
...
try {
		Debug.PushSubsStack("SetRange (roundslider) ","roundslider",43,__ref.getField(false, "ba"),__ref,176);
