...
try {
		Debug.PushSubsStack("Background_Click (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,258);
...
try {
		Debug.PushSubsStack("Background_Touch (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,253);
...
try {
		Debug.PushSubsStack("Blur (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,287);
...
try {
		Debug.PushSubsStack("Button_Click (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,233);
...
try {
		Debug.PushSubsStack("Close (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,239);
...
try {
		Debug.PushSubsStack("CreateButton (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,193);
...
try {
		Debug.PushSubsStack("GetButton (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,215);
...
try {
		Debug.PushSubsStack("getVisible (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,189);
...
try {
		Debug.PushSubsStack("InternalAddStubToCLVIfNeeded (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,343);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,339);
...
try {
		Debug.PushSubsStack("Resize (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,263);
...
try {
		Debug.PushSubsStack("SetAvg (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,325);
...
try {
		Debug.PushSubsStack("SetButtonState (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,223);
...
try {
		Debug.PushSubsStack("Stub_Click (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,349);
...
try {
		Debug.PushSubsStack("UpdateBlur (b4xdialog) ","b4xdialog",27,__ref.getField(false, "ba"),__ref,274);
