...
carrera.myClass = BA.getDeviceClass ("b4a.example.carrera");
carreras.myClass = BA.getDeviceClass ("b4a.example.carreras");
universidad.myClass = BA.getDeviceClass ("b4a.example.universidad");
universidades.myClass = BA.getDeviceClass ("b4a.example.universidades");
b4xuniversidades.myClass = BA.getDeviceClass ("b4a.example.b4xuniversidades");
b4xcarreras.myClass = BA.getDeviceClass ("b4a.example.b4xcarreras");
